...
export const getCollectionShareUrl = (collection: Collection | null | undefined): string | null => {
  ...
  const urls: Record<CollectionType, Record<TrackSource, string | null>> = {
    album: {
      ...
      qobuz: `https://play.qobuz.com/album/${collection.id}`,
      tidal: `https://listen.tidal.com/album/${collection.id}`,
      streaming: null,
      local: null,
    },
    playlist: {
      ...
      qobuz: `https://play.qobuz.com/playlist/${collection.id}`,
      tidal: `https://listen.tidal.com/playlist/${collection.id}`,
      streaming: null,
      local: null,
    },
    radio: {
